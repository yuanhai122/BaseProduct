...
//    if ([self.delegate respondsToSelector:@selector(didSelectCell:withSubViewIndex:)]) {
    if ([self.delegate respondsToSelector:@selector(didSelectFlowView:WithCell:withSubViewIndex:)]) {
        
//        [self.delegate didSelectCell:cell withSubViewIndex:selectTag];
        [self.delegate didSelectFlowView:self WithCell:cell withSubViewIndex:selectTag];
